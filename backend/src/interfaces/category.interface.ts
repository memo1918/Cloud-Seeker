...
export interface Category {
    ...
    description: string; // predefined description
    ...
    vendors: CategoryVendor[]; // list of vendors that are part of this category
    ...
    fields: CategoryField[]; // list of fields that are part of this category
